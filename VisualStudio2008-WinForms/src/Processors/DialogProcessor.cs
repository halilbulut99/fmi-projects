...
namespace Draw
{
    ...
    public class DialogProcessor : DisplayProcessor
    {
        ...
        public void AddRandomFigura4()
        {
            Random rnd = new Random();
            int x = rnd.Next(100, 1000);
            int y = rnd.Next(100, 600);

            Figura4 figura4 = new Figura4(new Rectangle(x, y, 100, 200));

            figura4.FillColor = Color.White;
            figura4.BorderColor = Color.Black;
            figura4.Opacity = 255;
            figura4.BorderWidth = 1;

            ShapeList.Add(figura4);
        }
        public void AddRandomf4()
        {
            Random rnd = new Random();
            int x = rnd.Next(100, 1000);
            int y = rnd.Next(100, 600);

            f4 f4 = new f4(new Rectangle(x, y, 200, 100));

            f4.FillColor = Color.White;
        ...
        public void AddRandomRec()
        {
            ...
            Rec rect = new Rec(new Rectangle(x, y, 100, 200));
        ...
        public void AddRandomFigura7()
        {
            Random rnd = new Random();
            int x = rnd.Next(100, 1000);
            int y = rnd.Next(100, 600);

            Figura7 figura7 = new Figura7(new Rectangle(x, y, 100, 125));
            figura7.FillColor = Color.White;
            figura7.BorderColor = Color.Black;
            figura7.Opacity = 255;
            ShapeList.Add(figura7);
        }
        ...
        public void AddRandomLine()
        {
            ...
            Line Line = new Line(new Rectangle(x, y, 100, 125));
